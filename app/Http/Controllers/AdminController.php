...
class AdminController extends Controller
{
    ...
    public function brand_store(Request $request){
        ...
        $this->GenereateBrandThumbnailsImage($image,$file_name);
    ...
    public function GenereateBrandThumbnailsImage($image, $imageName){
    ...
    public function category_store(Request $request){
        ...
        $file_extention = $request->file('image')->extension();
        $file_name = Carbon::now()->timestamp.'.'.$file_extention;
        $this->GenereateCategoryThumbnailsImage($image,$file_name);
        $category->image = $file_name;
        $category->save();
        return redirect()->route('admin.categories')->with('status','Category has been added succesfully!');
    }

    public function GenereateCategoryThumbnailsImage($image, $imageName){
    ...
    public function category_delete($id){
        ...
        $category->delete();
        return redirect()->route('admin.categories')->with('status', 'Catergory has been deleted successfully!');
    }
